...
%if %{fedora} > 26
#fc27 defines %%_debugsource_packages 1, resulting in empty debugsource packages which makes build error out
%undefine _debugsource_packages
%endif

# clang also provides clang-format
Requires:       libssh clang clang-tools-extra SDL
BuildRequires:	gcc gcc-c++ compat-wxGTK3-gtk2-devel cmake clang-devel lldb-devel libssh-devel hunspell-devel sqlite-devel libXtst-devel desktop-file-utils
